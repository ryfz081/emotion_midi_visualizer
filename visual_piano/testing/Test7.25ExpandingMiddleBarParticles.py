...
class ExpandingMiddleBar:
    ...
    def expand(self, velocity):
        ...
        self.color = ( abs(70-map_midi_velocity_to_intensity(velocity)*1), abs(30-map_midi_velocity_to_intensity(velocity)*0),  map_midi_velocity_to_intensity(velocity)*0.01)
        ...
        if self.height < (SCREEN_HEIGHT // 2):
            ...
            for _ in range(10):
                ...
                particle_color = (255,0,5) #self.color
