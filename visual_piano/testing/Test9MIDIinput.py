...
pygame.display.set_caption("MIDI File Loader")

font = pygame.font.Font(None, 25)  # Decreased font size to 25
text = ""
message = "MIDI file name? (without extension):"
error_message = ""

input_rect = pygame.Rect(20, 60, 360, 36)
...
while promptRunning:
    ...
    text_rect.centery = input_rect.centery  # Vertically center the text
    text_rect.left = input_rect.left + 5
    screen.blit(input_surface, text_rect.topleft)

    pygame.draw.rect(screen, (0, 0, 0), input_rect, 2)

    error_surface = font.render(error_message, True, (255, 0, 0))
    screen.blit(error_surface, (20, 100))
